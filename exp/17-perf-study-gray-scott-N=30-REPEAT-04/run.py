...
from helpers import FIGSIZE_TWO_SUBPLOTS_TWO_ROWS, exp, get_outdir

RESULT_DATA_PICKLE = "ivp_cvode_gs_data.pickle"

RESULT_PERF_FILENAME = os.path.join("_assets", "ivp_cvode_gs_performance.pdf")
